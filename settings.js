document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateProfileUI() {
        if (avatarEl) avatarEl.src = `https://ui-avatars.com/api/?name=${userData.name}&background=9d00ff&color=fff`;
        if (settingsAvatar) settingsAvatar.src = `https://ui-avatars.com/api/?name=${userData.name}&background=9d00ff&color=fff&size=150`;
        ...
        if (settingsCourse) settingsCourse.value = userData.course || "Not specified";
    }
    updateProfileUI();
    ...
    if (saveProfileBtn) {
        saveProfileBtn.addEventListener('click', () => {
            ...
            setTimeout(() => {
                ...
                userData.course = settingsCourse.value;
